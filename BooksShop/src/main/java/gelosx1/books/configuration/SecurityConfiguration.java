...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.GET,"/book/author/{author}/page/{current}/items/{items}").permitAll()
			.antMatchers(HttpMethod.GET,"/book/publisher/{publisher}/page/{current}/items/{items}").permitAll()
			.antMatchers(HttpMethod.POST,"/account/registration").permitAll()
			.antMatchers(HttpMethod.POST,"/account/login").permitAll()
			.antMatchers(HttpMethod.GET,"/book/all/page/{current}/items/{items}").permitAll()
